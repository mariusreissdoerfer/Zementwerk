...
} from './physics.js?v=14';
import { MATERIALS } from '../data/materials.js?v=14';
import { FUELS } from '../data/fuels.js?v=14';
import { classifyCement, strengthClass, PRICE_BY_CLASS } from '../data/cementTypes.js?v=14';
import {
  ECON, rawMaterialCost, additiveCost, fuelCost, co2Cost, maintenanceCost, updateMarket,
} from './economy.js?v=14';
import { unitAvailability, tickDisturbances, maybeTriggerEvent } from './events.js?v=14';
import { checkMissions } from '../game/scenarios.js?v=14';
import { fmtMoney } from '../util.js?v=14';
