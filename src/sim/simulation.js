...
import { MATERIALS } from '../data/materials.js?v=7';
import { FUELS } from '../data/fuels.js?v=7';
import { classifyCement, strengthClass, PRICE_BY_CLASS } from '../data/cementTypes.js?v=7';
import {
  ECON, rawMaterialCost, additiveCost, fuelCost, co2Cost, maintenanceCost, updateMarket,
} from './economy.js?v=7';
import { unitAvailability, tickDisturbances, maybeTriggerEvent } from './events.js?v=7';
import { checkMissions } from '../game/scenarios.js?v=7';
import { fmtMoney } from '../util.js?v=7';
