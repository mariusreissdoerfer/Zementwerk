...
import { MATERIALS } from '../data/materials.js?v=6';
import { FUELS } from '../data/fuels.js?v=6';
import { classifyCement, strengthClass, PRICE_BY_CLASS } from '../data/cementTypes.js?v=6';
import {
  ECON, rawMaterialCost, additiveCost, fuelCost, co2Cost, maintenanceCost, updateMarket,
} from './economy.js?v=6';
import { unitAvailability, tickDisturbances, maybeTriggerEvent } from './events.js?v=6';
import { checkMissions } from '../game/scenarios.js?v=6';
import { fmtMoney } from '../util.js?v=6';
...
export function simulate(state) {
  ...
  let elec = electricalEnergy({
    ...
    rawMealFineness: c.rawMealFineness, cementFineness: c.cementFineness, vrm: up.vrm,
  });
